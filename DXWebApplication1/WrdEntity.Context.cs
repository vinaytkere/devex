...
namespace DXWebApplication1
{
    ...
    public partial class wrdEntities1 : DbContext
    {
        public wrdEntities1()
            : base("name=wrdEntities1")
        {
        }
        ...
        public virtual int spGetAddress(string on, ObjectParameter add)
        {
            var onParameter = on != null ?
                new ObjectParameter("on", on) :
                new ObjectParameter("on", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetAddress", onParameter, add);
        }
    
        public virtual int spGetOfficeName(Nullable<int> id, ObjectParameter officename)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetOfficeName", idParameter, officename);
        }
    
        public virtual ObjectResult<spOffice_Result> spOffice(Nullable<int> omid)
        {
            var omidParameter = omid.HasValue ?
                new ObjectParameter("omid", omid) :
                new ObjectParameter("omid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spOffice_Result>("spOffice", omidParameter);
        }
    }
}
