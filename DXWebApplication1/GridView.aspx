<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GridView.aspx.cs" Inherits="DXWebApplication1.GridViewModule" Title="GridView" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName=" DXWebApplication1.Model.Issue"
        TypeName=" DXWebApplication1.Model.DataProvider"
        SelectMethod="GetIssues" InsertMethod="AddNewIssue" UpdateMethod="UpdateIssue"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ContactsDataSource" runat="server" DataObjectTypeName=" DXWebApplication1.Model.Contact"
        TypeName=" DXWebApplication1.Model.DataProvider"
